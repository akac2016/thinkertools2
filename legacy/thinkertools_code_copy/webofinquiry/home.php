...
<html lang="en">
	<head>
		...
		<title>Web of Inquiry home</title>
		...
		<div class="container">
			...
			<div class="column">
				<div class="contentbox blank">
					<span class="columnheadtitle">Welcome to the Web of Inquiry</span>
					<br /><br />
					Answer inquiry questions. Build new knowledge. Satisfy your curiosity. See more in <a href="../about.php" class="textlink">About</a> and <a href="../demos.php" class="textlink">Demos</a>, or search for current inquiry games.
					<?php 
					print '
						<form action="home.php?action=search" method="post" class="form" style="margin-top:28px">
						<textarea name="searchinput" type="text" class="textarea" spellcheck="true" style="min-width:470px; min-height:40px; max-height:72px" maxlength="200" placeholder="search criteria, 200 characters max" required />'.$searchinput.'</textarea>
						<input type="submit" name="submit" class="submitbutton" value="search for games" />
						</form>
					';
						require("gridview-wide.php");
					?>
				</div>
			</div>
			...
			<!-- right column -->
			<div class="column">
				<!-- log in message or play/design buttons -->
				<?php
					if (!isset($_SESSION['userID'])) {
						print '<div class="toolbox login" style="margin-top:36px; margin-bottom:48px">
						...
						$loc2 = "'play.php'";
						print '
						<div class="buttondiv" style="margin-top:48px; margin-bottom:48px">
							<div class="left">
								<button class="button150" onclick="window.location.href='.$loc1.';">Design a game</button>
							</div>
							<div class="left" style="margin-left:64px">
				...
				?>
				<!-- results -->
				<div class="contentbox woiborder" style="width: 600px; clear: both">
					<?php 
					if ($game_public == '(public)') {
						print '<div class="contentboxtitle" style="text-align:center">Highlight Game </div><br />';
						print '<strong>Question and description</strong><br />'; 
						echo $game_name; print '<br /><br />';
					...
					else print 'Game is in progress, results pending completion.';
					?>
				</div>
			</div>
		</div>
