...
?>
<!-- grid -->
<div class="griddiv griddiv-wide">
	<div class="gridrow gridrow-wide">
		<div class="gridcell gridcell-wide grid5"><?php print '<br /><a href="home.php?game_id='.$game5.'" class="leveltext ">'; echo $game5_name; print '</a><br /><br />'; echo $game5_public ?></div>
		<div class="gridcell gridcell-wide grid1"><?php print '<br /><a href="home.php?game_id='.$game1.'" class="leveltext">'; echo $game1_name; print '</a><br /><br />'; echo $game1_public ?></div>
		<div class="gridcell gridcell-wide grid6"><?php print '<br /><a href="home.php?game_id='.$game6.'" class="leveltext">'; echo $game6_name; print '</a><br /><br />'; echo $game6_public ?></div>
	</div>
	<div class="gridrow gridrow-wide gridadjust">
		<div class="gridcell gridcell-wide grid3"><?php print '<br /><a href="home.php?game_id='.$game3.'" class="leveltext">'; echo $game3_name; print '</a><br /><br />'; echo $game3_public ?></div>
		<div class="gridcell gridcell-wide grid0"><br />
			<?php 
				if ($game_id==0) print '<br /><br />no matches';
				else { echo $game_name; print '<br /><br />'; echo $game_public; }
			 ?>
		</div>
		<div class="gridcell gridcell-wide grid4"><?php print '<br /><a href="home.php?game_id='.$game4.'" class="leveltext">'; echo $game4_name; print '</a><br /><br />'; echo $game4_public ?></div>
	</div>
	<div class="gridrow gridrow-wide gridadjust">
		<div class="gridcell gridcell-wide grid8"><?php print '<br /><a href="home.php?game_id='.$game8.'" class="leveltext">'; echo $game8_name; print '</a><br /><br />'; echo $game8_public ?></div>
		<div class="gridcell gridcell-wide grid2"><?php print '<br /><a href="home.php?game_id='.$game2.'" class="leveltext">'; echo $game2_name; print '</a><br /><br />'; echo $game2_public ?></div>
		<div class="gridcell gridcell-wide grid7"><?php print '<br /><a href="home.php?game_id='.$game7.'" class="leveltext">'; echo $game7_name; print '</a><br /><br />'; echo $game7_public ?></div>
	</div>
</div>